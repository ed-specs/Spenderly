...
import MoneyCardModal from "./MoneyCardModal";
    ...
    <>
      ...
      <div className="md:hidden">
        ...
        <div className="flex items-center justify-center gap-4 mt-2">
          ...
          <button
            onClick={prevCard}
            className="flex items-center justify-center gap-2 size-8 bg-white hover:bg-gray-50 rounded-full border border-gray-200 transition-all duration-200 shadow-sm cursor-pointer"
            aria-label="Previous card"
          >
            <ChevronLeft strokeWidth={1.5} className="size-4.5 text-gray-700" />
          </button>
      ...
      <div className="flex col-gap-4 w-full">
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex">
            ...
            >
              <span className="text-xs sm:text-sm">View all transactions</span>
